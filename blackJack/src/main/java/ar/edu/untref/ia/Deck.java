...
public class Deck {
	...
	// A deck contains a list of strings representing cards. It's interacted
	// with by the player and the dealer.
	public Deck() {
		this.listOfCards = new ArrayList<>();
		String[] cards = { "2 of Diamonds", "2 of Hearts", "2 of Clubs", "2 of Spades", "3 of Diamonds", "3 of Hearts",
